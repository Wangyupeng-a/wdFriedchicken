						...
						<div class="col-md-8">
							<table class="table shop-cart">
								<tbody>
									...
									%>
									<tr class="cart_item" style="rowspan:2;">
										<td   style="font-size: 15px;"><%=listshopcar.get(i).getCartime().toString().substring(0, 16)%>
										</td>
										...
										<td class="product-quantity">
											<div class="quantity">
											<span><%=listshopcar.get(i).getCarspnumber()%> </span>
											</div>
										</td>
									...
									<tr>
										<td colspan="5" class="actions">
											...
											<a  href="servlet/ShopcarokServlet?userid=<%=usersid%>" class="update-cart" style="font-weight: bold;">更新购物清单</a>
											 </td>
									</tr>
								</tbody>
							</table>
